 ...
 * |---------------------------------------------------------------------------------
 *
 * Version 2021: Fernando Castro Canosa
 *
 */
...
const double Accel_Z_corrector = 16384.0;	//valor original: 14418.0
#define TIMEOUT_I2C 10	//valor original: 10

// Setup for a gyro full scale range of +/-250°/s and 131.0°/s steps
// XG_ST=0, YG_ST=0, ZG_ST=0, FS_SEL=0 -> +/- 250°/s
#define GYRO_AFS_SEL 0x00
#define GYRO_LSB 131.0

// Setup for a accel full scale range of +/-2g and 16384.0g steps
// XA_ST=0, YA_ST=0, ZA_ST=0, FS_SEL=0 -> +/-2g
#define ACCEL_AFS_SEL 0x00
#define ACCEL_LSB 16384.0
...
void MPU6050_Read_Accel(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct) {
    ...
    DataStruct->Ax = DataStruct->Accel_X_RAW / ACCEL_LSB;
    DataStruct->Ay = DataStruct->Accel_Y_RAW / ACCEL_LSB;
...
void MPU6050_Read_Gyro(I2C_HandleTypeDef *I2Cx, MPU6050_t *DataStruct) {
    ...
    DataStruct->Gx = DataStruct->Gyro_X_RAW / GYRO_LSB;
    DataStruct->Gy = DataStruct->Gyro_Y_RAW / GYRO_LSB;
    DataStruct->Gz = DataStruct->Gyro_Z_RAW / GYRO_LSB;
}
